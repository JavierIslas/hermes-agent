...
def test_relay_rewrite_precedes_sequential_policy_approval_checkpoint_and_dispatch():
    ...
    with (
        ...
        patch(
            "hermes_cli.plugins.resolve_pre_tool_block_details",
...
def test_plugin_pre_tool_block_wins_without_counting_as_toolguard_block():
    ...
    with (
        patch("hermes_cli.plugins.resolve_pre_tool_block_details", return_value=("plugin policy", False)),
...
def test_plugin_halt_loop_directive_sets_guardrail_halt():
    ...
    with patch("hermes_cli.plugins.resolve_pre_tool_block_details",
               return_value=(block_msg, True)):
