...
class TestGatewayLifecyclePattern:
    ...
    @pytest.mark.parametrize("text", [
        ...
        # Branch D positives (fork dogfooding D8): pkill/kill targeting the gateway process,
        # both token orders — kept from the fork's expansion of this parameter list.
        "pkill -f hermes-gateway",
        "kill the hermes gateway process",
        "pkill gateway hermes",
    ])
