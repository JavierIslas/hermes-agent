...
def _pre_dispatch_guards(function_name: str, function_args: Dict[str, Any], skip_pre_tool_call_hook: bool,
    ...
    if not skip_pre_tool_call_hook:
        ...
        try:
            ...
            # Fix D5 (arnes-gates): the dispatcher returns a tri-tuple
            # (block_message, modified_args, halt_loop); direct callers
            # outside the conversation loop ignore the halt flag.
